...
const jsonResponses = {
  ...
  'https://openbase.com/graphql': {
    data: {
      package: {
        starRating: 4.69,
        starRatingCount: 8438,
        rowId: '3669c575-1ef4-44f2-a228-03eb4dc91546',
        badges: {
          nodes: [
            {
            ...
            },
            {
              ...
              urlSlug: 'highly-custom',
              isPositive: true,
              voteCount: 221,
            },
            {
              name: 'Bleeding Edge',
              urlSlug: 'bleeding-edge',
              isPositive: true,
              voteCount: 141,
            },
            {
              name: 'Responsive Maintainers',
              urlSlug: 'responsive-maintainers',
              isPositive: true,
              voteCount: 132,
            },
            {
            ...
            {
              name: 'Unwelcoming Community',
              urlSlug: 'unwelcoming-community',
              isPositive: false,
              voteCount: 5,
            },
          ],
